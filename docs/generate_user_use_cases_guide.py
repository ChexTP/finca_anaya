...
def build_document():
    ...
    add_use_cases(
        ...
        [
            ...
            ("ADM-06", "Inventario", "Revisar lotes disponibles y aprobados.", "Debe ver pesos, humedad, merma, perfil/tipo y estado.", ""),
    ...
    add_use_cases(
        ...
        [
            ...
            ("BOD-04", "Bodega", "Registrar humedad y merma por trilla.", "Los porcentajes quedan visibles en pendientes de laboratorio.", ""),
            ("BOD-05", "Bodega", "Intentar guardar merma mayor a 100.", "El sistema debe rechazar el dato.", ""),
    ...
    add_use_cases(
        ...
        [
            ...
            ("LAB-03", "Laboratorio", "Ver humedad y merma registrada en bodega.", "Debe ver esos datos antes de decidir.", ""),

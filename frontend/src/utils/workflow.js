...
export const getSaleNextAction = (sale) => {
  const actions = {
    ...
    proceso_solicitado: "Laboratorio debe confirmar el inicio del proceso",
    en_proceso: "Esperando finalizacion y analisis de laboratorio",
    listo_para_ensamble: "Laboratorio debe definir mezcla o liberar para alistar",
